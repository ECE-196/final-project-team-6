...
/*
This function will initialize the display, set the font, 
and place the cursor at the top left corner. It also 
turns off the power saving feature so the 
OLED does not go to sleep on us during testing. 
*/
void setupDisplay() {   
